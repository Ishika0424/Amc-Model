    ...
    <div className="space-y-6">
      ...
      >
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <DialogTitle>Add Remark: {selectedTask?.title}</DialogTitle>
            <DialogDescription>
              Add a remark or update about your progress on this task
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Describe your progress, any issues encountered, or updates on the task..."
                rows={4}
              />
            </div>
          </div>
          <DialogFooter>
            ...
            <Button onClick={handleSubmitRemark}>Save Remark</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
